...
// //   //   documentTitle: `Payment_Receipt_${payment?.id || "default"}`,
// //   //   // Trigger the print automatically when the component mounts
// //   //   // onAfterPrint: () => onClose(), // Optional: Close the dialog after printing
// //   // })
...
// //       pdf.save(`Payment_Receipt_${payment.id}.pdf`)
// //     } catch (error) {
...
// //                 {hasDiscount && (
// //                   <tr>
// //                     <td className="border p-2 text-green-600">{t("discount")}</td>
...
// //                 {hasCarryForward && (
// //                   <tr>
// //                     <td className="border p-2 text-blue-600">{t("carry_forward")}</td>
...
// //                 {hasRemaining && (
// //                   <tr>
// //                     <td className="border p-2 text-amber-600">{t("remaining_amount")}</td>
// //                     <td className="border p-2 text-right text-amber-600">{formatCurrency(payment.remaining_amount)}</td>
// //                   </tr>
// //                 )}
// //               </tbody>
// //               <tfoot>
...
// //                 <div className="mt-10 border-t border-dashed w-40 pt-1">
...
//       pdf.addImage(imgData, "PNG", 0, 0, imgWidth, imgHeight)
//       pdf.save(`Payment_Receipt_${payment?.id || "default"}.pdf`)
//     } catch (error) {
//       console.error("Error generating PDF:", error)
//     }
//   }
