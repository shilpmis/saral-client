...
//         console.log("Check the error" , user!.teacher_id , tpye === 'create')
...
export const LeaveApplicationForm: React.FC<LeaveApplicationFormProps> = ({ initialData, onCancel, type }) => {
    const user = useAppSelector(selectCurrentUser)
    const leavePolicyForUser = useAppSelector(selectLeavePolicyForUser)
